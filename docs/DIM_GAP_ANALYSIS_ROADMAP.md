...
| Feature                                 | DIM Source Reference       | Description                                                                                                                                                                                                                                                                             | Effort     |
| --------------------------------------- | -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| **Loadout Optimizer / Armor Builder**   | `src/app/loadout-builder/` | Web Worker-powered armor optimization engine to hit specific stat tiers. *Phase 1 shipped (v0.35.0), Phase 2 shipped (v0.36.0) — worker rewrite, exotic picker, auto stat mods, DIM-style UI. See Loadout Optimizer section below.* | Very High  |
| ~~**Loadout Optimizer / Armor Builder**~~   | `src/app/loadout-builder/` | ~~Web Worker-powered armor optimization engine to hit specific stat tiers.~~ **Phase 1 DONE** (v0.35.0) — Worker, types, pre-filter, stat constraints, results. **Phase 2 DONE** (v0.36.0) — `addStats` bug fix, flat stat arrays, exotic picker, auto stat mods, DIM-style inline results UI with Bungie icons. | ~~Very High~~  |
